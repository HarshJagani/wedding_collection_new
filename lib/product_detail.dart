...
import 'package:wedding_collection_new/book_product_screen.dart';
              ...
              child: ElevatedButton(
                onPressed: () async {
                  await Navigator.push(
                      ...
                      MaterialPageRoute(
                        builder: (context) => 
                            BookProductScreen(productId: widget.productId),
                      ));
                  _loadProductDetails();
        ...
        child: Column(
          children: [
            SizedBox(
              ...
              child: PageView.builder(
                ...
                itemBuilder: (context, index) {
                  String imageUrl = Helprtmethods().convertGoogleDriveLink(_product.images[index]); // Actual image URL
            ...
            _bookedDates.isEmpty
                ? NoBookingWidget()
                : BookingDetailsCard(
                    booking: _bookedDates, onCancel: _cancelBooking)
          ],
        ),
      ),
    );
